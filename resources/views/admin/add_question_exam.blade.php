            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::hidden('exam_id', $result->id) }}
                      ...
                      <div class="row">
                        <label for="remainingQuestion" class="pull-right control-label">Remaning Question {{ $result->total_question - $result1 }}</label>
                      </div>

                      <div class="form-group">
                        <label for="questionNumber" class="col-sm-2 control-label">Question No</label>
                        <label for="questionNumber" class="col-sm-1 control-label">{{$result1+1}}</label>
                      </div>
