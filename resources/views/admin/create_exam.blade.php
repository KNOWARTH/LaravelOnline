        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">    
                   <!--  -->
                    {{ Form::open(array('url' => '/saveExam', 'method' => 'post','class' => 'form-horizontal')) }}
                    {{ csrf_field() }}
                     <div class="row">
                      ...
                      <div class="form-group">
                        <label for="duration_per_que" class="col-sm-2 control-label">Duration Per Question (Minute)</label>
                        <div class="col-sm-5">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="mark_per_que" name="mark_per_que" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="passMark" name="passing_marks" required>
                        </div>
                      </div>
