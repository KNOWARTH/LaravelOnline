        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!--  -->
                    {{ Form::open(array('url' => 'updateUserProfile', 'method' => 'post','class' => 'form-horizontal')) }}
                    {{ csrf_field() }}
                    {{ Form::hidden('id',$result->id) }}
                     <div class="row">
                        {{ HTML::link('', "" , array('class' => 'btn btn-primary glyphicon glyphicon-arrow-left pull-right'))}}
                    </div>
